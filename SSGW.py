...
def SSGW(kd,kH2, N=2048, tol=1e-14):
    ...
    plt.legend('Surface Elevation','Still Water Level');
    ...
    print(f'Number of positive Fourier modes:     N = %9i\n' % N);
    print('Tolerance:                          tol = %15.14e\n'% tol);
    print('Number of iterations:              iter = %9i\n'% iter);
    print('Residual:                           res = %9i\n'% errfun);
    print('Iterations time (s)                time = %15.14f\n'% toc);
    print('PHYSICAL PARAMETERS'               );
    print('Mean depth:                           d = %15.14e\n'% d);
    print('Acceleration due to gravity:          g = %15.14e\n'% g);
    wl =  2*np.pi/k
    print('Wavelength:                      2*pi/k = %15.14e\n'% wl);
    print('WAVE CHARACTERISTICS'            );
    print('Wave height:                          H = %15.14f\n'% H);
    print('Crest height (amplitude):             a = %15.14f\n'% a);
    print('Trough height:                        b = %15.14f\n'% b);
    print('Stokes first phase celerity:        c_e = %15.14f\n'% ce);
    print('Stokes second phase celerity:       c_s = %15.14f\n'% cs);
    sqglam =  np.sqrt(g*lam)
    print('Linear phase celerity:              c_0 = %15.14f\n'% sqglam);
    print('Bernoulli constant:                   B = %15.14f\n'% B);
    print('');
    print('INTERGRAL QUANTITIES (in the frame of reference with zero circulation)\n'             );
    print('Impulse:                              I = %15.14f\n'% intI);
    print('Potential energy:                     V = %15.14f\n'% intV);
    print('Kinetic energy:                       K = %15.14f\n'% intK);
    print('Radiation stress:                   Sxx = %15.14f\n'% intSxx);
    if d!=np.inf:
        print('Momentum flux:                        S = %15.14f\n'% intS);
    print('Energy flux:                          F = %15.14f\n'% intF);
    print('Group celerity:                     c_g = %15.14f\n'% cg);
    return [zs,ws,PP]
